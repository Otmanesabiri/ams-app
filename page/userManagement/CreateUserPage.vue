      ...
      <div>
        ...
        <form @submit.prevent="submit" class="space-y-5 max-w-2xl">
          ...
          <UFormField :label="$t('userForm.firstName')">
            <UInput v-model="form.firstName" :placeholder="$t('userForm.enterFirstName')" variant="outline" class="w-full" />
          </UFormField>

          <UFormField :label="$t('userForm.lastName')">
            <UInput v-model="form.lastName" :placeholder="$t('userForm.enterLastName')" variant="outline" class="w-full" />
          </UFormField>
